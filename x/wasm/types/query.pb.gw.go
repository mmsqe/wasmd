...
var (
	...
	pattern_Query_Blacklist_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"cosmwasm", "wasm", "v1", "contract", "blacklist"}, "", runtime.AssumeColonVerbOpt(false)))
)
